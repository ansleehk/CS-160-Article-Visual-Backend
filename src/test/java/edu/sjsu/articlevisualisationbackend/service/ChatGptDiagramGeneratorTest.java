...
public class ChatGptDiagramGeneratorTest {
    ...
    @Test
    public void testGenerateDiagram() throws InvalidChatGptGeneration, IOException {
        ...
        ChatGptDiagramGenerator chatGptDiagramGenerator = new ChatGptDiagramGenerator();
        chatGptDiagramGenerator.setPdfText(ARTICLE);
